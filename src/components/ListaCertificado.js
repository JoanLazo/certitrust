...
const ListaCertificado = () => {
    ...
    return(
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">CertiTrust<sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="buttons.html">Derecho</a>
                    <a class="collapse-item" href="utilities-color.html">Administración y Finanzas</a>
                    <a class="collapse-item" href="utilities-border.html">Arquitectura</a>
                    <a class="collapse-item" href="utilities-animation.html">Ciencias de la Computación</a>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="utilities-color.html">Nuevos Alumnos</a>
                ...
                <div class="row">
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Fechas de envio</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">30 de cada mes</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card border-left-success shadow h-100 py-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total de carreras</div>
                    ...
                    <div class="card border-left-info shadow h-100 py-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Certificados enviados</div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
 ...
 <div class="col-xl-3 col-md-6 mb-4">
            ...
            <footer class="sticky-footer bg-white">
                ...
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; CertiTrust 2019</span>
                </div>
                </div>
            </footer>
            {/* <!-- End of Footer --> */}
...
export default ListaCertificado;
